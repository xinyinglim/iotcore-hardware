...
#mqtt demo is working, what is wrong with the others?
#make a demo where cloud func pulls and saves to firebase
# eg> return temp readings
#make it easy to set return readings ever 5 mins etc

# figure out how to install jwt to ev3, eg by connecting to wifi then ssh? then you can pip install there
...
gateway_id = "" #Not required
jwt_expires_minutes = 1000
listen_dur = 60
# indicates whether a message to be published is a telemetry event or a device state message
message_type = 'state'
mqtt_bridge_hostname = "mqtt.googleapis.com"
mqtt_bridge_port = 8883
service_account_json = "./keys/iotcore-key.json"
...
def on_message(unused_client, unused_userdata, message):
    ...
    #todo set so that as you receive topics in commands or config, you update things as needed
    


def get_client(
        project_id, cloud_region, registry_id, device_id, private_key_file,
        algorithm, ca_certs, mqtt_bridge_hostname, mqtt_bridge_port, device_on_message):
...
# todo listen forever and update the loop as necessary
# use threading and do it simulaneously as you do the distance sensor
...
#     jwt_exp_mins = jwt_expires_minutes
#     client = get_client(
#         project_id, cloud_region, registry_id,  #todo fill a pull request not gatewayid
...
#     print(configParser.get('your-config', 'device_id'))

# configTxtParser()
#todo data = "The telemetry data sent on behalf of a device"


# def main():
#     args_command = 'gateway_send' #args.command = 'gateway_send'

#     # args = parse_command_line_args()

#     if args_command == 'gateway_listen':
#         listen_for_messages(
#                 service_account_json, project_id,
#                 cloud_region, registry_id, device_id,
#                 gateway_id, num_messages, private_key_file,
#                 algorithm, ca_certs, mqtt_bridge_hostname,
#                 mqtt_bridge_port, jwt_expires_minutes,
#                 listen_dur)
#         return
#     elif args_command == 'gateway_send':
#         send_data_from_bound_device(
#                 service_account_json, project_id,
#                 cloud_region, registry_id, device_id,
#                 gateway_id, num_messages, private_key_file,
#                 algorithm, ca_certs, mqtt_bridge_hostname,
#                 mqtt_bridge_port, jwt_expires_minutes, data)
#         return
#     else:
#         mqtt_device_demo()
#     print('Finished.')
...
#     mqtt_device_demo()
    #sendInput()
# to change to variables, and have ev3 output a message